...
<body>
  ...
  <div id="demo" class="carousel slide" data-bs-ride="carousel">
    ...
    <div style="height:600px;width: 100%;" class="carousel-inner">
      <div class="carousel-item active">
        <img style="height:600px;width: 100%;" src="images/buet.jpg" alt="Los Angeles" class="d-block w-100">
      </div>
      <div class="carousel-item">
        <img style="height:600px;width: 100%;" src="images/2.jpeg" alt="Chicago" class="d-block w-100">
      </div>
      <div class="carousel-item">
        <img style="height:600px;width: 100%;" src="images/uiu.jpg" alt="New York" class="d-block w-100">
      </div>
    </div>
    ...
    <div class="col">
      <div class="card">
        ...
        <div class="card-body">
          ...
          <a style="margin: 5px;width: 97%;padding: 5px;font-family: 'Dosis', sans-serif;" href="login.html" class="btn btn-secondary">Details</a>
        </div>
      </div>
    </div>
    <div class="col">
    ...
    <div class="col">
      <div class="card">
        ...
        <div class="card-body">
          ...
          <a style="margin: 4px;padding: 5px;width: 97%;font-family: 'Dosis', sans-serif;" href="login.html" class="btn btn-secondary">Details</a>
        </div>
      </div>
    </div>
    <div class="col">
    ...
    <div class="col">
      <div class="card">
        ...
        <div class="card-body">
          ...
          <a style="margin: 5px;padding: 5px;font-family: 'Dosis', sans-serif;width: 97%;" href="login.html" class="btn btn-secondary">Details</a>
        </div>
      </div>
    </div>
  </div>
  ...
  <form style="width:30%;margin: auto;" action="action_page.php" style="border:1px solid #ccc; margin-top: 80px;">
    <div class="container2">
      ...
      <div class="clearfix">
        ...
        <button style="width:100%;font-family: 'Dosis', sans-serif;" type="submit" class="signupbtn">Sign Up</button>
        <button style="height: 50px;font-family: 'Dosis', sans-serif;" class="btn btn-dark"><a style="text-align: center;text-decoration: none;color: aliceblue;" href="login.html">Login</a></button>
      </div>
    </div>
  </form>
